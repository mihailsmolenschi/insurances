...
import { closeSignUp, toggleModal } from "../data/uiSlice";
  ...
  return (
    <div className={styles.signup}>
      <div className={styles["title-close"]}>
        <h2>Înregistreaza-te</h2>
        <button className={styles["close-btn"]} onClick={handleCloseSignup}>
          <svg
            width="26"
            height="26"
            viewBox="0 0 33 32"
      ...
      <p className={styles.login}>
        Deja ai un cont? <a>Logheaza-te</a>
      </p>
      <form>
        ...
        <div className={styles["form-check"]}>
          ...
          <label htmlFor="terms">
            Sunt de acord cu <a href="#">Termenii și condițiile</a> site-ului
          </label>
        </div>
